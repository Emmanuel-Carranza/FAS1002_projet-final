...
Ma première banque de données provient de Our Wold in Data[@noauthor_covid-19_2021].Grâce à leur merveilleux travail, j'ai pu acccèder au fichier .CSV sur leur page Github qui contient les données de vaccinations de chaque pays mise à jour régulièrement. Ma deuxième provient tout droit de la fondation [Gapminder](https://www.gapminder.org/) qui nous fournit de l'information quant au [effectif de population](https://docs.google.com/spreadsheets/d/14_suWY8fCPEXV0MH7ZQMZ-KndzMVsSsA5HdR-7WqAC0/edit#gid=501532268)[@noauthor_gm-population_nodate] ainsi que de [l'espérance de vie](https://docs.google.com/spreadsheets/d/11mulzUH3_cueq-V9D5KIlo9oHE9YYZrUSeVyCin7_rM/edit#gid=501532268)[@noauthor_gm-life_nodate-1] de chaque pays.
...
J'ai simplement selectionné les colonnes "location" pour les pays et "2021.0" puisque j'écris cette analyse en 2021. J'ai crée une autre banque de données avec les mêmes variables mais pour les continents

### Manipulation des données d'espérance de vie

J'ai fais exactement la même chose que pour la précédante.

Une explication plus détaillée des manipulations des 3 banques se trouve à la page [3-manipulation](3-manipulation.html)
